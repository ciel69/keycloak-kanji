...
<h1 class="text-2xl font-bold mb-6 text-center text-foreground">${msg("loginTitle","Вход в систему")}</h1>
...
<div class="space-y-4">
  ...
  <#if realm.registrationAllowed>
    <div class="text-center" id="kc-registration">
      <a href="${url.registrationUrl}" class="min-h-[44px] inline-flex items-center text-sm text-plum-600 hover:text-plum-700 dark:text-plum-400 dark:hover:text-plum-300 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-plum-500 focus-visible:ring-offset-2 focus-visible:ring-offset-surface">
  ...
  <#if social.providers?? && social.providers?size gt 0>
    ...
    <div class="relative">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-2 bg-surface text-faint">${msg("or","Или")}</span>
      </div>
    </div>
