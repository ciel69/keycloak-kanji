...
- [ ] 3. FreeMarker-шаблоны аутентификации
  - [ ] 3.1 Реализовать `login.ftl` (форма входа)
    ...
    - _Requirements: 2.4, 3.3, 4.1, 6.1, 6.2, 6.7_
  ...
  - [ ] 3.3 Реализовать `register.ftl` (форма регистрации)
  ...
  - [ ] 3.5 Реализовать шаблоны сброса пароля
  ...
  - [ ] 3.6 Реализовать `login-verify-email.ftl` и `login-otp.ftl`
...
- [ ] 5. Декларативная конфигурация `realm-export.json`
  ...
  - [ ] 5.3 Настроить клиент `nest-api` и маппер ролей
  ...
  - [ ] 5.4 Добавить Telegram identity provider
...
- [ ] 6. Образ, переменные окружения и hostname/прокси
...
- [ ] 8. Integration / smoke / snapshot тесты (сторона Keycloak)
...
```json
{
  "waves": [
    ...
    { "id": 2, "tasks": ["3.1", "3.3", "3.5", "3.6", "2.6", "5.1"] },
    { "id": 3, "tasks": ["3.2", "3.4", "4.1", "5.2"] },
